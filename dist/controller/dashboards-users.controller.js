...
var DashboardUsersController = /** @class */ (function () {
    ...
    var _a;
    _a = DashboardUsersController;
    DashboardUsersController.getDashboardsByUserId = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
        var repository, userId, dashboardByUserResponse, dashboardsUser, e_1;
    ...
    DashboardUsersController.parseDashboardResponse = function (dashboardsUser) {
        var dashboardInformationArray = [];
        dashboardsUser.map(function (dashboardUser) {
            var dashboard = dashboardUser.dashboard;
